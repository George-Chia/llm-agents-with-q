...
An action should be one of the following structures:
search[keywords]
click[value]
think[something]
If the action is not valid, perform nothing.
Keywords in search and something in think are up to you, but the value in click must be a value in the list of available actions.
Remember that your keywords in search should be carefully designed.
Remember NOT to call the search action twice in a row unless you act a click[Back to Search] action in the middle of the call.
---
Here is an example.
