...
trajectories_save_path = 'webshop/trajectories-SimpleQ-StepLevelCritique-checkpoint52_test_webshop_T1.0_simple_1iterations'
...
for file in os.listdir(trajectories_save_path):
    ...
    all_max_q_value_index_list.extend(result['max_q_value_index_list'])
