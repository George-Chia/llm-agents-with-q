...
trajectories_save_path_comparision = 'hotpot/trajectories-5n-critique-wrong-InTurn/trajectories-MCTS-critique-disable_early_stop_train_llama31_mcts_20iterations'
